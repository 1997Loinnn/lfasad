<template>
    <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20" id="about">
        ...
        <div class="flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg">
          ...
          <div class="max-w-xl mb-6">
            <h2 class="max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none">
                Biz haqimizda<br class="hidden md:block" />
              
              <span class="inline-block text-deep-purple-accent-400"></span>
            </h2>
            <p class="text-base text-gray-700 md:text-lg">
                Xususiy uylar qurilishi zamonaviy inson tomonidan tobora ommalashib bormoqda. Shu munosabat bilan, binoning tashqi bezaklari uchun oqilona ehtiyoj bor, bu egasining didi va afzalliklarini aks ettiradi. Uyning jabhasini tugatish nafaqat dekorativ rolni bajaradi, balki binoni ob-havo sharoitidan himoya qilish funktsiyalarini ham bajaradi. 
                Shuning uchun uyni loyihalash bosqichida izolyatsiyalash uchun materiallar va variantlarni ko'rib chiqishga arziydi. Xususiy uyning jabhasini tugatishga qiziqqan - kompaniyamiz bilan bog'laning. Uyning tashqi bezaklari atrofdagi landshaft bilan uyg'un bo'lishi va ideal rang sxemasi haqidagi g'oyalaringizga mos kelishi uchun barcha kerakli ishlarni bajarishga yordam beramiz.
            </p>
          </div>
          <div>
