<template>
    <div class="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20" id="service">
      <div class="flex flex-col mb-6 lg:flex-row md:mb-10">
        <div class="lg:w-1/2">
          <h2 class="max-w-md mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none xl:max-w-lg">
            Biz ko'rsatadigan xizmatlar
          </h2>
        </div>
        <div class="lg:w-1/2">
          <p class="text-base text-gray-700 md:text-lg">
            Bino va inshoatning tashqi va ichki ta'mirlash ishlari bo'yicha xizmatlar ko'rsatamiz. Biz sizga sifatli va ishonchli xizmatlarni taklif qilamiz, ko'p yillik tajriba evaziga
          </p>
        </div>
      </div>
      <div class="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <h6 class="mb-2 font-semibold leading-5">Tashqi ko'rinish</h6>
          <p class="mb-3 text-sm text-gray-900">
            Bino va inshoatning tashqi ko'rinishini tayor holatga keltirish.
          </p>
          ...
          <a href="/" aria-label="" class="inline-flex items-center font-semibold transition-colors duration-200 text-deep-purple-accent-400 hover:text-deep-purple-800">Ko'proq ma'lumot</a>
        </div>
        <div>
          <div class="flex items-center justify-center w-16 h-16 mb-4 rounded-full bg-indigo-50">
          ...
          <h6 class="mb-2 font-semibold leading-5">Tosh ishlari</h6>
          <p class="mb-3 text-sm text-gray-900">
            Tosh ko'rinish uchun ishlatiladigan tosh ishlari bo'yicha
          </p>
          <ul class="mb-4 -ml-1 space-y-2">
            <li class="flex items-start">
              <span class="mr-1">
        ...
        <div>
          ...
          <h6 class="mb-2 font-semibold leading-5">Ichki ta'mirlash</h6>
          <p class="mb-3 text-sm text-gray-900">
            Qulay va shinam xonalar xolatga kelishini tam'inlaymiz.
          </p>
          <ul class="mb-4 -ml-1 space-y-2">
            <li class="flex items-start">
              <span class="mr-1">
        ...
        <div>
          ...
          <h6 class="mb-2 font-semibold leading-5">Santexnika va Elektrika</h6>
          <p class="mb-3 text-sm text-gray-900">
            Binoning santexnika va elektrik ishlarini 0 dan qilamiz.
          </p>
          <ul class="mb-4 -ml-1 space-y-2">
            <li class="flex items-start">
              <span class="mr-1">
